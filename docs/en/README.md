...
1. Open [Releases](https://github.com/simhanson123/Doc_Viewer/releases) (**v0.4.4+**).
2. Download installer (`*-win-x64.exe`) or portable (`*-win-portable.exe`).
3. Run → **Open** or `Ctrl+O` → choose a PDF / MD / TXT / DOCX / EPUB.

> Prefer **v0.4.4 or newer**. Earlier 0.4.0–0.4.1 builds had PDF path/worker issues.
