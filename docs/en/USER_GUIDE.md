...
| Symptom | What to try |
|---------|-------------|
| PDF blank | Use **v0.4.11+**. View → Developer tools → `[onjeom pdf]`. Help → Path diagnostics. |
...
| PDF export garble (Hangul/CJK) | Use **v0.4.11+** (canvas export path). |
| TOC click does nothing | Ensure the document has headings/structure; try **v0.4.11+**. |
