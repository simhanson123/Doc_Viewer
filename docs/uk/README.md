...
**v0.4.7** · Multi-format document viewer with freehand annotation.  
...
1. [Releases](https://github.com/simhanson123/Doc_Viewer/releases) → **v0.4.7+**
...
| Format | Notes |
|--------|--------|
| PDF | Needs v0.4.7+ (`onjeom://` + pdf.js worker IPC) |
