...
1. [Releases](https://github.com/simhanson123/Doc_Viewer/releases)에서 **v0.4.3 이상** 받기  
2. 실행 → **문서 열기** / `Ctrl+O` → PDF·MD·TXT·DOCX·EPUB 선택  

> 0.4.0~0.4.1 은 PDF 경로 문제가 있었습니다. **0.4.3+** 를 사용하세요.
...
- **PDF**: 패키지 앱은 `onjeom://` 프로토콜 + PDF 워커 IPC 폴백 (v0.4.3+)  
