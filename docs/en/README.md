...
1. Open [Releases](https://github.com/simhanson123/Doc_Viewer/releases) (**v0.4.9+**).
2. Download installer (`*-win-x64.exe`) or portable (`*-win-portable.exe`).
3. Run → **Open** or `Ctrl+O` → MD / TXT / HTML / PDF / DOCX / PPTX / EPUB.

> Prefer **v0.4.9 or newer**. Builds 0.4.0–0.4.1 had PDF path/worker issues; use current release.
