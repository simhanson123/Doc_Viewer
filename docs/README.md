...
Other languages include the same v0.4.9 feature set (overview + guide + build) with links back to EN/KO for detail.
...
```
docs/<lang>/
  README.md       # Overview & quick start (v0.4.9 features)
